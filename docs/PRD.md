...
3. Launch Microsoft Edge through a Playwright persistent context using that snapshot.
...
- Update artifacts include the installer, blockmap, and `latest.yml` with hashes generated by electron-builder.
